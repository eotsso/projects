...
/*
  So this code first must run the coincidence(string) function to find the unknown key length MANUALLY. 
  Then using the key length, you can pass the encrypted text along with the key length to get the Vigenere key. 
  The function using freqency analysis, and references https://cs.wellesley.edu/~fturbak/codman/letterfreq.html for
  frequency values. 
*/
...
void VE_Decrypt(string encryptedText, int coincidenceVal) {
    int counterVal = 0; 
